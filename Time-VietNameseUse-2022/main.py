...
data = pd.read_csv("C:/Users/bluei/OneDrive/Máy tính/Github_Project/IndivizualProject/VisualizeDuration/VNM_2022_TUS_v01_M_CSV/4_diary_main.csv", 
                   encoding='latin-1', usecols=["ID", "BEGIN", "Q401"],  converters={"Q401": get_activity, "BEGIN": convert_time})
